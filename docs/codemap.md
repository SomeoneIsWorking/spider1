...
| The framework itself | `external/psxport/` | **not this repo's subsystem** — a workspace symlink or private checkout with its own history and codemap. Framework changes land in that repo; this consumer was Clang-built and policy-verified at `2b5ef7b5` on 2026-08-21, recorded in `psxport.pin` |
